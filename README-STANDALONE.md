...
The demo account starts with five cards in its active hand, 30 turns, and 200 test coins. The credentials are intentionally public demo data; do not reuse the password for another account or service.
