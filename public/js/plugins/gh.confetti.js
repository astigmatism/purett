gh.confetti = {
    ...
    initialize: function(wrapper) {
        $(wrapper).append('<div id="confetti" class="abs"></div>');
...
confetti = function(parent) {
    this.initialize(parent);
};
confetti.prototype = {
    initialize: function(parent) {
        this.canvasParent = document.getElementById(parent);
        ...
        for (i = 0; i < this.confettiRibbonCount; i++) {
            this.confettiRibbons[i] = new ConfettiRibbon(Math.random() * this.canvas.width, -Math.random() * this.canvas.height * 2, this.rpCount, this.rpDist, this.rpThick, 45, 1, 0.05);
        }
        this.confettiPaperCount = 25;
        this.confettiPapers = [];
        ...
        $(this.canvasParent).hide();
    },
    resize: function() {
        this.canvas.width = this.canvasParent.offsetWidth;
        this.canvas.height = canvasParent.offsetHeight;
        this.ConfettiPaper.bounds = new Vector2(this.canvas.width, this.canvas.height);
        this.ConfettiRibbon.bounds = new Vector2(this.canvas.width, this.canvas.height);
    },
    start: function() {
        this.stop();
        var me = this;
