...
gh.snow.prototype = {
    ...
    initialize: function(wrapper) {
        ...
        me.container = $('<div id="snow" class="abs"></div>')
        $(wrapper).append(me.container);
        
        me.camera = new THREE.Camera(75, me.width / me.height, 1, 10000);
        me.camera.position.z = 1000;
        
        me.scene = new THREE.Scene();
        
        me.numberofparticles = (Math.random() * 200) + 200;
        
        me.particleImage = new Image();
        me.particleImage.src = '/images/ParticleSmoke.png';
        ...
        for (var i = 0; i < me.numberofparticles; i++) {
            
            me.particle = new Particle3D(new THREE.ParticleBitmapMaterial(me.particleImage));
            me.particle.position.x = Math.random() * 2000 - 1000;
            me.particle.position.y = Math.random() * 2000 - 1000;
            me.particle.position.z = Math.random() * 2000 - 1000;
            me.particle.scale.x = me.particle.scale.y = 1;
            me.scene.addObject(me.particle);
            
            me.particles.push(me.particle);
        }
    ...
    loop: function() {
        ...
        me.camera.position.x += (me.mouseX - me.camera.position.x) * 0.05;
        me.camera.position.y += (-me.mouseY - me.camera.position.y) * 0.05;
    ...
    stop: function(callback) {
        var me = this;
        if (me.running) {
            $(me.container).fadeOut(2000, function() {
    ...
    start: function(callback) {
        var me = this;
        if (!me.running) {
            $(me.container).fadeIn(2000, function() {
                if (gh.defined(callback, 'function')) {
                    callback();
                }
            });
...
THREE.Color.prototype = {setRGBA: function(f, e, c, d) {
        this.r = f;
        this.g = e;
        this.b = c;
        this.a = d;
...
THREE.Vector3.prototype = {set: function(a, c, b) {
        this.x = a;
        this.y = c;
        this.z = b;
        return this
...
THREE.Vector4.prototype = {set: function(a, d, c, b) {
        this.x = a;
        this.y = d;
        this.z = c;
        this.w = b;
...
THREE.Ray.prototype = {intersectScene: function(f) {
        ...
        for (n = 0, j = g.faces.length; n < j; n++) {
            ...
            if (k < 0) {
                ...
                if (i instanceof THREE.Face3) {
                    if (l(m, t, s, q)) {
                        o = {distance: this.origin.distanceTo(m),point: m,face: i,object: w};
                        e.push(o)
                    }
                } else {
...
THREE.Matrix4.prototype = {n11: 1,n12: 0,n13: 0,n14: 0,n21: 0,n22: 1,n23: 0,n24: 0,n31: 0,n32: 0,n33: 1,n34: 0,n41: 0,n42: 0,n43: 0,n44: 1,identity: function() {
        this.n11 = 1;
        this.n12 = 0;
        this.n13 = 0;
        this.n14 = 0;
...
THREE.Vertex.prototype = {toString: function() {
...
THREE.UV.prototype = {copy: function(a) {
        this.u = a.u;
        this.v = a.v
    },toString: function() {
...
THREE.Geometry.prototype = {computeCentroids: function() {
        ...
        if (this.vertices.length > 0) {
            this.bbox = {x: [this.vertices[0].position.x, this.vertices[0].position.x],y: [this.vertices[0].position.y, this.vertices[0].position.y],z: [this.vertices[0].position.z, this.vertices[0].position.z]};
...
THREE.Loader.prototype = {loadAsciiOld: function(a, c) {
        ...
        d.onmessage = function(h) {
            var g = h.data.materials, f = h.data.buffers;
        ...
        var e = new XMLHttpRequest(), c = d + "/" + b;
        ...
        var d = function(k) {
            ...
            this.computeNormals();
            function v(E, F) {
                var D = {signature: j(E, F, 8),header_bytes: x(E, F + 8),vertex_coordinate_bytes: x(E, F + 9),vertex_index_bytes: x(E, F + 10),normal_index_bytes: x(E, F + 11),material_index_bytes: x(E, F + 12),normal_coordinate_bytes: x(E, F + 13),uv_coordinate_bytes: x(E, F + 14),nvertices: t(E, F + 15),ntri_flat: t(E, F + 15 + 4 * 1),ntri_smooth: t(E, F + 15 + 4 * 2),nquad_flat: t(E, F + 15 + 4 * 3),nquad_smooth: t(E, F + 15 + 4 * 4),nnormals: t(E, F + 15 + 4 * 5),nuvtri: t(E, F + 15 + 4 * 6),nuvquad: t(E, F + 15 + 4 * 7),};
                return D
            }
            function j(E, F, D) {
                return E.substr(F, D)
            ...
            function B(G, F) {
                var H = x(G, F), J = x(G, F + 1), K = x(G, F + 2), L = x(G, F + 3), E = 1 - (2 * (L >> 7)), I = (((L << 1) & 255) | (K >> 7)) - 127, D = ((K & 127) << 16) | (J << 8) | H;
                if (D == 0 && I == -127) {
                    return 0
                }
            ...
            function t(H, I) {
                var G = x(H, I), F = x(H, I + 1), E = x(H, I + 2), D = x(H, I + 3);
                return (D << 24) + (E << 16) + (F << 8) + G
            }
            function y(F, G) {
                var E = x(F, G), D = x(F, G + 1);
                return (D << 8) + E
            }
            function q(E, F) {
                var D = x(E, F);
                ...
                if (D.map_diffuse && k) {
                    ...
                    H.onload = function() {
                        if (!f(this.width) || !f(this.height)) {
                            var I = i(this.width), J = i(this.height);
                            F.bitmap.width = I;
                            F.bitmap.height = J;
...
THREE.Mesh.prototype.sortFacesByMaterial = function() {
    ...
    for (e = 0, m = this.geometry.faces.length; e < m; e++) {
        ...
        n = a(h);
        if (g[n] == undefined) {
            g[n] = {hash: n,counter: 0}
        }
        d = g[n].hash + "_" + g[n].counter;
        if (this.materialFaceGroup[d] == undefined) {
            this.materialFaceGroup[d] = {faces: [],material: h,vertices: 0}
        }
...
THREE.LineColorMaterial.prototype = {toString: function() {
...
THREE.SVGRenderer = function() {
    var x = null, r = new THREE.Projector(), t = document.createElementNS("http://www.w3.org/2000/svg", "svg"), b, o, p, s, z = new THREE.Rectangle(), w = new THREE.Rectangle(), i = false, k = new THREE.Color(4294967295), v = new THREE.Color(4294967295), c = new THREE.Color(4294967295), g = new THREE.Vector3(), d = [], l = [], B, n, f, A = 1;
    this.domElement = t;
    this.autoClear = true;
...
THREE.WebGLRenderer = function(q) {
    var h = document.createElement("canvas"), f, n, k = new THREE.Matrix4(), d, g = 0, c = 1, s = 2, o = 3, l = b(q, 5);
    this.domElement = h;
    this.autoClear = true;
    a();
    ...
    function b(x, y) {
        ...
        return {directional: 1,point: y - 1}
    }
    ...
    this.createBuffers = function(M, K) {
        var I, A, C, z, H, L, y, w, v, u, t, x = M.materialFaceGroup[K], E = [], G = [], D = [], J = [], F = [], B = 0;
    ...
    function a() {
        try {
            f = h.getContext("experimental-webgl", {antialias: true})
        } catch (t) {
        }
        if (!f) {
