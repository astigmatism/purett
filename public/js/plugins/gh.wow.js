...
//***********************************************
function ws_stack(options, images) {
    var $ = jQuery;
    var curIdx = 0;
    ...
    this.go = function(new_index) {
        images.each(function(Index) {
            if (Index == curIdx) {
                ...
                $(this).stop(1, 1).css({'z-index': 2,left: "auto",right: -options.width + "px"}).show().animate({right: 0}, options.duration, "easeInOutExpo");
            } else {
                $(this).css({'z-index': 0});
            }
        });
...
jQuery.fn.wowSlider = function(options) {
    var $this = this;
    var $ = jQuery;
    options = $.extend({effect: function(options) {
            var images;
        ...
        },prev: "",next: "",duration: 1000,delay: 2000,outWidth: 960,outHeight: 360,width: 960,height: 360,caption: true,controls: true,autoPlay: true,bullets: true,onStep: function() {
        },stopOnHover: 0}, options);
        ...
        if ($thumbs.length) {
            ...
            $bullets_cont.hover(function() {
                ...
                if (document.all) {
                    ...
                    mainFrame.stop().animate({opacity: 0}, {duration: "fast",complete: function() {
                            mainFrame.hide();
                        }});
                }
            });
    ...
    function showWithSlide(element, options) {
        ...
        if (element.css("position") == "static") {
            ...
            $.extend(wrap_props, {position: element.css("position"),zIndex: element.css("z-index")});
        ...
        wrapper.animate({opacity: 1}, {duration: options.duration,easing: options.easing});
...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect: "stack",prev: "",next: "",duration: 10 * 100,delay: 20 * 100,outWidth: 960,outHeight: 360,width: 960,height: 360,autoPlay: true,stopOnHover: true,loop: false,bullets: true,caption: true,controls: true});
